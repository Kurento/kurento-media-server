...
PointerDetectorFilter::Factory::StaticConstructor::StaticConstructor()
{
  if (objectRegistrar) {
    std::shared_ptr <Factory> factory (new PointerDetectorFilter::Factory());
...
void
PointerDetectorFilter::Invoker::invoke (std::shared_ptr<MediaObject> obj,
    ...
    Json::Value &response)
{
  if (methodName == "addWindow" && params.size() == 1) {
    ...
    std::shared_ptr<PointerDetectorFilter> finalObj;
    finalObj = std::dynamic_pointer_cast<PointerDetectorFilter> (obj);
    if (!finalObj) {
      JsonRpc::CallException e (JsonRpc::ErrorCode::SERVER_ERROR_INIT,
...
std::string
PointerDetectorFilter::connect(const std::string &eventType, std::shared_ptr<EventHandler> handler)
{
...
void
Serialize(std::shared_ptr<kurento::PointerDetectorFilter> &object, JsonSerializer &serializer)
{
  if (!serializer.IsWriter) {
    try {
      std::shared_ptr<kurento::MediaObject> aux;
      aux = kurento::PointerDetectorFilter::Factory::getObject (serializer.JsonValue.asString ());
      object = std::dynamic_pointer_cast<kurento::PointerDetectorFilter> (aux);
      return;
    } catch (kurento::JsonRpc::CallException &ex) {
      kurento::JsonRpc::CallException e (kurento::JsonRpc::ErrorCode::SERVER_ERROR_INIT,
                              "'PointerDetectorFilter' object not found: "+ ex.getMessage());
      throw e;
    }
  }
...
void
Serialize(kurento::PointerDetectorFilter &object, JsonSerializer &serializer)
{
