...
class ChromaFilter : public virtual Filter {

public:

  ChromaFilter () {};
  virtual ~ChromaFilter () {};

  virtual void setBackground (const std::string& uri) {throw "Not implemented";};
  virtual void unsetBackground () {throw "Not implemented";};
  ...
  private:
    ...
    MediaObject * createObject (std::shared_ptr<MediaPipeline> mediaPipeline, std::shared_ptr<WindowParam> window, const std::string& backgroundImage);
