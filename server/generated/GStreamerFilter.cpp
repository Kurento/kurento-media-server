...
MediaObject * GStreamerFilter::Factory::createObjectPointer (const Json::Value &params)
{
  ...
  if (!params.isMember ("command")) {
    /* param 'command' not present, raise exception */
    JsonRpc::CallException e (JsonRpc::ErrorCode::SERVER_ERROR_INIT,
                              "'command' parameter is requiered");
    throw e;
  } else {
    JsonSerializer s(false);
    s.JsonValue = params;
...
GStreamerFilter::Factory::StaticConstructor::StaticConstructor()
{
  if (objectRegistrar) {
    std::shared_ptr <Factory> factory (new GStreamerFilter::Factory());
...
void
GStreamerFilter::Invoker::invoke (std::shared_ptr<MediaObject> obj,
...
std::string
GStreamerFilter::connect(const std::string &eventType, std::shared_ptr<EventHandler> handler)
{
...
Serialize(std::shared_ptr<kurento::GStreamerFilter> &object, JsonSerializer &serializer)
{
  if (!serializer.IsWriter) {
    try {
      ...
      aux = kurento::GStreamerFilter::Factory::getObject (serializer.JsonValue.asString ());
      ...
      kurento::JsonRpc::CallException e (kurento::JsonRpc::ErrorCode::SERVER_ERROR_INIT,
                              "'GStreamerFilter' object not found: "+ ex.getMessage());
      throw e;
    }
  }
...
void
Serialize(kurento::GStreamerFilter &object, JsonSerializer &serializer)
{
