...
- Fix several leaks that caused constant increment of memory usage for each new WebRTC session: [gst-plugins-bad!422](https://gitlab.freedesktop.org/gstreamer/gst-plugins-bad/merge_requests/422).
